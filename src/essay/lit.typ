...
=== Main Title theme from Star Wars: A New Hope - John Williams // ^sw
...
#figure(image("../figs/star_wars.svg"))
...
=== Prelude in G minor - Sergei Rachmaninoff // ^gr
...
// #figure(image("../figs/dont_stop_me_now.svg"))
...
=== Shelter - Porter Robinson, Madeon // ^pr
...
#figure(image("../figs/shelter.svg"))

The beginning of the song uses warm, synthesized pad sounds, along with a melody based on vocal chopping, to create its signature sound. Vocal Chopping is the "altering [of] a sampled phrase by dividing it into smaller segments and reconfiguring them in a different order" @defineChopping. This method of creating something new out of something old is an apt metaphor for nostalgia, a "longing for the past," by taking something from the past and using it to make something new.
...
=== Sweden - C418 // ^c4
Another piece that creates a nostalgic feeling, this time paired with melancholy, slow piano, is _Sweden_ by C418. Although much of the nostalgia from this song comes from the popularity of the game it comes from, _Minecraft_, this does not discredit how music theory contributes to this song's calm, nostalgic feeling.

// #figure

A big contributor to this song's nostalgic feeling is its usage of empty space. While many piano pieces tend to fill space with eighth notes, _Sweden_ is content with having empty space. This gives it a calm, contemplative feeling. As you can see, the tempo is 44 beats per minute, which is less than half of a standard 120. All of these factors contribute to the melancholy, contemplative, and ultimately nostalgic emotion.

The cultural significance of this piece cannot go unmentioned. To players of _Minecraft_, this song hold unique sentimental value. It reminds players of their times spent playing the game, chopping trees and building houses. A popular video game blog, Kotaku, placed the album _Minecraft: Volume Alpha_, which contains _Sweden_, as one of the best video game soundtracks from 2011 @swedenReview. This shows its cultural and emotional significance.

_Sweden_ is a nostalgic piece; not just because of its cultural significance, but also because of its use of empty space and slow tempo that creates a contemplative and ultimately nostalgic feeling.
...
=== Classical Music // ^cm
In contrast to rhythmic and sonic manipulation as found in electronic music, classical musicians achieve emotional build-up through a sophisticated interplay of melodic contour, harmonic progression, and rhythmic variation. While lacking the immediate impact of a percussive "drop" or the sweeping effects of filters, classical music cultivates tension and release through more gradual and nuanced techniques.

A Glissando is a quick run of notes in succession. While commonly seen in piano music, the same technique can apply to many instruments. Glissandos can be found all over romantic-era classical music. One example is Beethoven's _Sonata No. 8 in C minor, "Pathétique"._ The introduction ends with a grand glissando into the main theme, which is more rhythmically complicated and harder to play. This chromatic scale builds tension because it creates anticipation for what is going to happen next.

// figure

Later in _Pathétique_, we also see the second method of building tension: chord sequences. This simply means playing a succession of chords that all approach one place. This builds tension because, if done well, one chord leads perfectly into the next chord, continuing until at the point the composer wants.

// another figure

Through these methods of building tension, classical composers don't need drums or filtering; they can use musical techniques to build tension and release it in their pieces.

== Music that doesn't use theory // ^a
Although we can explain a lot of parts of music through theory, for some music, this is impossible, or at least infeasible. But it is undeniable that these types of music still evoke emotion. Experimental Electronica music, such as the album _Drukqs_ by Aphex Twin, and Hardcore Punk Rock music are two examples of this phenomenon.

==== Aphex Twin
The album _Drukqs_ by Aphex Twin largely avoids music theory alltogether. Despite the songs' lack of common chord progressions or standard melodies, the music still evokes complex emotions in listeners. Through the use of complicated drum programming and abstract, synthesized melodies, Listeners say that the emotion evoked by this album is "useless trying to explain this track in words" @drukqsReddit. A popular music blog, In Sheep's Clothing, explained the album this way: "Drukqs is a sycamore — one to marvel over once you notice the intricacies of its roots, branches and life unfolding throughout the bark and on its leaves. This album builds atmospheres that help exercise the mind in the same way that classical music, with its own palette of sounds, does" @drukqsReview. While it is not possible to explain this album in music theory terms, it is clear that _Drukqs_ by Aphex Twin evokes complex emotional response.
